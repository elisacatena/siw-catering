...
import static it.uniroma3.siw.catering.model.Credenziali.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/chef/**", "/buffet/**","/piatto/**","/ingrediente/**", "/index", "/login", "/css/**", "/images/**", "/contatti/**", "/chi-siamo/**").permitAll()
